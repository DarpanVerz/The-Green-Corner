...
class VariantSelects extends HTMLElement {
	...
	updateMedia() {
		...
		if (
			...
			document.querySelector(".js-media-list").swiper != null
		) {
			document.querySelector(".js-media-list").swiper.destroy();
		}
...
(function () {
	const onClickOpacity = () => {
		...
		const lists = document.querySelectorAll(".header-mega-submenu .mega-menu-list");
